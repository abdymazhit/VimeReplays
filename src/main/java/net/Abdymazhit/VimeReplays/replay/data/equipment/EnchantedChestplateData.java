...
/**
 * Конструктор создания записи изменения зачарованной экипировки (нагрудник) игрока для сериализации
 *
 * @version   27.07.2021
 * @author    Islam Abdymazhit
 */
public class EnchantedChestplateData extends EnchantedItemData implements Serializable {
    ...
    /**
     * Инициализирует запись изменения зачарованной экипировки (нагрудник) игрока
     */
    ...
    /**
     * Выполняет действия изменения зачарованной экипировки (нагрудник) игрока
     */
    public void performAction() {
        ...
        npc.setEquipment(EquipmentType.CHESTPLATE, itemStack);
    }
}