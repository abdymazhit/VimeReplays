...
/**
 * Отвечает за запись изменения незачарованной экипировки (штаны)
 *
 * @version   02.08.2021
 * @author    Islam Abdymazhit
 */
public class LeggingsData extends ItemData {

    /** Пустой инициализатор (нужен для создания через class.newInstance()) */
    public LeggingsData() { }

    /**
     * Инициализирует запись изменения незачарованной экипировки (штаны)
     */
    ...
    /**
     * Выполняет действия изменения незачарованной экипировки (штаны)
     */
