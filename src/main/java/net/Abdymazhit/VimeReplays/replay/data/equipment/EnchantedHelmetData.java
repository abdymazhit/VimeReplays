...
/**
 * Конструктор создания записи изменения зачарованной экипировки (шлем) игрока для сериализации
 *
 * @version   27.07.2021
 * @author    Islam Abdymazhit
 */
public class EnchantedHelmetData extends EnchantedItemData implements Serializable {
    ...
    /**
     * Инициализирует запись изменения зачарованной экипировки (шлем) игрока
     */
    ...
    /**
     * Выполняет действия изменения зачарованной экипировки (шлем) игрока
     */
