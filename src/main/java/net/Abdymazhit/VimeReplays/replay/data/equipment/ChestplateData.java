...
/**
 * Конструктор создания записи изменения незачарованной экипировки (нагрудник) игрока для сериализации
 *
 * @version   27.07.2021
...
public class ChestplateData extends ItemData implements Serializable {
    ...
    /**
     * Инициализирует запись изменения незачарованной экипировки (нагрудник) игрока
     */
    ...
    /**
     * Выполняет действия изменения незачарованной экипировки (нагрудник) игрока
     */
