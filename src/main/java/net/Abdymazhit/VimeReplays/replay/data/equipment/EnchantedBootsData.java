...
/**
 * Конструктор создания записи изменения зачарованной экипировки (ботинки) игрока для сериализации
 *
 * @version   27.07.2021
 * @author    Islam Abdymazhit
 */
public class EnchantedBootsData extends EnchantedItemData implements Serializable {
    ...
    /**
     * Инициализирует запись изменения зачарованной экипировки (ботинки) игрока
     */
    ...
    /**
     * Выполняет действия изменения зачарованной экипировки (ботинки) игрока
     */
